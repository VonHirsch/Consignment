...
@section( 'layout.dashboard.with-title' )
    <ns-consignors-statement inline-template>
                    ...
                    <div class="my-4 flex justify-between w-full">
                        <div class="text-primary">
                            <ul>
                                ...
                                <li class="pb-1 border-b border-dashed border-box-edge">{{ __( 'Document : Consignors Statement' ) }}</li>
    ...
    </ns-consignors-statement>
@endsection

@section( 'layout.dashboard.footer.inject' )
<script>
    Vue.component( 'ns-consignors-statement', {
        data() {
            return {
        ...
        methods: {
            ...
            handleSelectedCustomer( customer ) {
                ...
                nsHttpClient.post( `/dashboard/consignment/reports/consignors-statement/${customer.id}`, {
